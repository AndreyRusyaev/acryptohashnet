...
{
    [TestFixture]
    public class LittleEndianBufferTests
    {
        [Test]
        public void CopyBytesToUintsTest()
        {
            ...
            LittleEndianBuffer.BlockCopy(input, 0, output, 0, input.Length);
        ...
        public void CopyUintsToBytesTest()
        {
            ...
            LittleEndianBuffer.BlockCopy(input, 0, output, 0, output.Length);

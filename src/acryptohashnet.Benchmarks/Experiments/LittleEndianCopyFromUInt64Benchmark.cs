...
{
    [MemoryDiagnoser]
    public class LittleEndianCopyFromUInt64Benchmark
    {
        ...
        [Benchmark]
        public void LittleEndianBench()
        {
            LittleEndian.Copy(UInt64Input, Bytes);
        }
        ...
        public void SeveralShiftsInCycle()
        {
            ...
            {
                bytes[ii] = unchecked((byte)(input & 0xff));
                input >>= 8;
            }
        }
        ...
        public void OneShiftAnds()
        {
            ...
            bytes[7] = (byte)(input >> 56);
            bytes[6] = (byte)(input >> 48);
            bytes[5] = (byte)(input >> 40);
            bytes[4] = (byte)(input >> 32);
        ...
        public void OneShiftAndsUnchecked()
        {
            ...
            bytes[7] = unchecked((byte)((input >> 56) & 0xff));
            bytes[6] = unchecked((byte)((input >> 48) & 0xff));
            bytes[5] = unchecked((byte)((input >> 40) & 0xff));
            bytes[4] = unchecked((byte)((input >> 32) & 0xff));
            bytes[3] = unchecked((byte)((input >> 24) & 0xff));
            bytes[2] = unchecked((byte)((input >> 16) & 0xff));
            bytes[1] = unchecked((byte)((input >> 8) & 0xff));
            bytes[0] = unchecked((byte)(input & 0xff));
        }
    }
}
